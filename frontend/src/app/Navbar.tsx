...
const NavBar = () => {
  ...
  const getLinkClass = (path: string) => {
    const bothStyle = "duration-200 font-bold text-lg ";
    const resStyle =
      pathName?.includes(path)
        ? "relative text-white after:absolute after:left-0 after:bottom-[-28px] after:w-full after:h-[4px] after:bg-white"
  ...
  return (
    <nav className="flex items-center gap-10 bg-uninterTheme-600 p-5 box-border">
      <Link href="/home">
        <Image
